...
RAG_VOICE_MEMORY_TIMEOUT_SECONDS = _float_env("RAG_VOICE_MEMORY_TIMEOUT_SECONDS", 0.4)
RAG_VOICE_RAG_TIMEOUT_SECONDS = _float_env("RAG_VOICE_RAG_TIMEOUT_SECONDS", 1.2)
RAG_VOICE_WEB_TIMEOUT_SECONDS = _float_env("RAG_VOICE_WEB_TIMEOUT_SECONDS", 2.0)
